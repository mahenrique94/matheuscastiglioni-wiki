...
- [BETH](https://github.com/ethanniser/the-beth-stack)
...
- [Architecture Flipbook](https://learning.oreilly.com/library/view/design-it/9781680502923/f_0128.xhtml)
...
- [Cloud Events](https://cloudevents.io/)
- [COCOMO (Constructive Cost Model)](http://softwarecost.org/tools/COCOMO/)
- [CONOPSSE (Concept of Operations)](https://acqnotes.com/acqnote/careerfields/concept-of-operations-conopsse)
- [COSYSMO (Constructive Systems Engineering Cost Model)](https://en.wikipedia.org/wiki/COSYSMO)
- [CPD (Capability Production Document)](https://acqnotes.com/acqnote/tasks/capability-production-documentrequirements)
- [CRC (Component Responsibility Cards)](https://en.wikipedia.org/wiki/Class-responsibility-collaboration_card)
...
- [Mini QAW (Quality Attribute Workshop)](https://re-magazine.ireb.org/articles/discover-quality-requirements-with-the-mini-qaw/)
...
- [PoV (Point of View)](https://www.merriam-webster.com/words-at-play/point-of-view-first-second-third-person-difference)
- [PRD (Product Requirements Document)](https://medium.com/machine-words/writing-technical-design-docs-71f446e42f2e)
- [SAD (Software Architecture Description)](https://en.wikipedia.org/wiki/Software_architecture_description)
