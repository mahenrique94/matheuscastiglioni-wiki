...
- Binario para código ([https://binary.ninja/](https://binary.ninja/))
- Bloquear websites para manter o focu ([https://freedom.to/](https://freedom.to/))
- Buscar informações do sistema operacional ([https://github.com/fastfetch-cli/fastfetch](https://github.com/fastfetch-cli/fastfetch))
...
- Compartilhar arquivos ([https://github.com/schollz/croc](https://github.com/schollz/croc))
- Compartilhar arquivos com dispositivos próximos ([https://localsend.org/](https://localsend.org/))
- Compartilhar sessões de terminais na web ([https://github.com/tsl0922/ttyd](https://github.com/tsl0922/ttyd))
...
- Edição de videos ([https://www.boomvideo.app](https://www.boomvideo.app))
...
- Manipular PDFs ([https://www.bentopdf.com/](https://www.bentopdf.com/))
- Mockar requisições HTTP ([https://get.mokku.app](https://get.mokku.app))
- Motor para executar códigos ([https://github.com/engineer-man/piston](https://github.com/engineer-man/piston))
...
- Pair-Programming Remoto ([https://tuple.app/](https://tuple.app/))
